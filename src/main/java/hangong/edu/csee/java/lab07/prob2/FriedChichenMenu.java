 ...
 * and throwing Chicken class print the result to console
 */
...
/**
 * This class default class of this .java 
 * first we initialize the data and receive data from main function
 * by input data return the result
 */
